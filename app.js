require('dotenv').config();const express = require('express');const mongoose = require('mongoose');const md5 = require('md5');const path = require('path');const app = express();const port = 3000;const DATABASE_URL = process.env.DATABASE_URL;
